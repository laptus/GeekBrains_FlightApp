...
-(void) createContentDataArray{
    NSArray* titles = [NSArray arrayWithObjects:[@"about" localize], [@"air_tickets" localize],[@"price_map" localize], [@"favourites" localize], nil];
    NSArray* contents = [NSArray arrayWithObjects:[@"tickets_sale" localize],[@"find_cheap_tickets" localize],[@"search_tickets_on_map" localize],[@"save" localize], nil];
    for (int i=0; i<4; ++i){
...
- (void)pageViewController:(UIPageViewController*) pageViewController
        didFinishAnimating:(BOOL)finished previousViewControllers:( NSArray<UIViewController*>
...
- ( void)updateButtonWithIndex:(int)index {
    switch (index) {
        ...
        case 1:
        case 2:
            [ _nextButton setTitle: [@"next" localize] forState : UIControlStateNormal];
            _nextButton.tag = 0;
            break;
        case 3:;
            [ _nextButton setTitle :[@"ok" localize] forState : UIControlStateNormal];
            _nextButton.tag = 1;
            break;
        default:
            break;
